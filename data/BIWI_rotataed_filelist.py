...
root_dir = './datasets/BIWI_rotated/rotated'
label_dir = './datasets/BIWI_rotated/BIWI_rot_annotations'
...
np.savetxt('./datasets/BIWI_rotated/train.txt', file_list, fmt='%s', delimiter='/n')
...
for img_path in test_list:
    ...
    if os.path.exists(os.path.join(root_dir, img_path)) and os.path.exists(label_path) and os.path.exists(mask_path):
        file_list.append(os.path.join(root_dir, img_path) + ',' + label_path + ',' + mask_path)
np.savetxt('./datasets/BIWI_rotated/test.txt', file_list, fmt='%s', delimiter='/n')
